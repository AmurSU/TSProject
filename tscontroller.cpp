...
void TSController::processDataParams(){
    ...
    qtw->setItem(9,0,getQTableWidgetItem(tr("Дыхательный объем")));
    qtw->setItem(9,1,getQTableWidgetItem(BreathingVolume));


    MVL = ga->getMVL();
    qtw->setItem(10,0,getQTableWidgetItem(tr("Минутная вентиляция легких")));
    ...
    qtw->setItem(11,0,getQTableWidgetItem(tr("Средняя температура вдоха")));
    ...
    qtw->setItem(12,0,getQTableWidgetItem(tr("Средняя температура выдоха")));
    qtw->setItem(12,1,getQTableWidgetItem(AvgTempOut));

    AvgTempInMinusAvgTempOut = AvgTempOut-AvgTempIn;
    qtw->setItem(13,0,getQTableWidgetItem(tr("Средняя Твдоха-Средняя Твыдоха")));
